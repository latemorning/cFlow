...
<script type="text/javaScript" language="javascript">
	function initCalendar(){
	 var varForm = document.getElementById("vctnManage");
		$("#bgnde").datepicker(
		        {dateFormat:'yy-mm-dd'
		         , showOn: 'button'
...
function fncNoonSeSpan(vValue){
    ...
    if(vValue == "02"){
    	...
    	vTemp += '   <form:form modelAttribute="vctnManage" name="vctnManage" method="post" ><form:hidden path="endde"/></form:form>';
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="vctnManage" name="vctnManage" method="post" >
	<form:hidden  path="applcntId" id="applcntId"/>
	<form:errors  path="applcntId"/>

	<!-- 타이틀 -->
	<h2 class=""><spring:message code="comUssIonVct.vcatnRegist.title"/> VctnRegist</h2><!-- 휴가신청 -->
	...
	<table class="wTable mb20">
		...
		<tr>
			...
			<td class="left">
			    <c:out value='${yrycManageVO.applcntNm}'/>
			</td>
			<th><spring:message code="comUssIonVct.common.orgnztNm"/></th><!-- 소속 -->
			<td class="left">
			    <c:out value='${yrycManageVO.orgnztNm}'/>
			</td>
		</tr>
		<tr>
			<td class="left" colspan="4">
				<span>[<spring:message code="comUssIonVct.common.occrncYrycCo"/>: ${yrycManageVO.occrncYrycCo}  ]</span><!-- 발생연차 -->
				<span style="margin-left:20px">[<spring:message code="comUssIonVct.common.useYrycCo"/>: ${yrycManageVO.useYrycCo}  ]</span><!-- 사용연차 -->
				<span style="margin-left:20px">[<spring:message code="comUssIonVct.common.remndrYrycCo"/>: ${yrycManageVO.remndrYrycCo}  ]</span><!-- 잔여연차 -->
			</td>
		</tr>
		<tr>
